...
<div id="content" class="group">
  <h2><%=(rsPage.Fields.Item("PageTitle").Value)%><% if Session("MM_Username") <> "" AND Session("MM_UserID") = rsArticles.Fields.Item("fldAuthorID").Value OR Session("MM_isAdmin") = 1 Then %> | <a href="update_page.asp?pagename=<%=(rsPage.Fields.Item("pagename").Value)%>">Edit this post</a><% end if %></h2>
<div class="main"> 
