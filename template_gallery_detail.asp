...
if request("layout") <> "" then
	If session("layout") <> "" Then
		layoutConfig = "Themes/" & session("layout") & "/template_gallery_detail.asp"
	Else
		Response.End	
	End If
elseif session("layout") <> "" Then
	...
	layoutConfig = "Themes/" & rsLayoutConfig.Fields.Item("blogLayout").Value & "/template_gallery_detail.asp"
end if
