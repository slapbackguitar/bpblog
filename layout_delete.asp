...
<body>
	...
	<div id="main">
		<div id="contents">
          <h2>Delete a Layout</h2>
<p><strong>Delete Layout:</strong> <%=(rsLayouts.Fields.Item("layoutid").Value)%> - <a href="default.asp?layout=<%=(rsLayouts.Fields.Item("layoutid").Value)%>" target="_blank">Preview it first</a>? </p>
